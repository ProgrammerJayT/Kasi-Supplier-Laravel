...
<body style="background: var(--bs-gray-dark);">
    ...
    <div class="container">
        <div class="d-sm-flex justify-content-between align-items-center mb-4" style="padding: 20px;">
            <h2 class="text-light mb-0" style="color: var(--white-color);font-size: 32px;font-family: 'Alegreya Sans', sans-serif;">Markets</h2><a class="btn btn-outline-info border rounded-pill border-info shadow-lg" role="button" href="{{route('CreateProd')}}">Add A Product</a>
        </div>
    </div>
    <div class="container">
        <div>
