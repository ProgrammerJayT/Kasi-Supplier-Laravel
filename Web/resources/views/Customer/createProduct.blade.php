                    ...
                    <div class="card shadow mb-5" style="margin: 0px -100px 48px;background: var(--bs-gray-dark);">
                        <div class="card-body d-flex flex-column align-items-center">
                            <form class="text-center" method="post">
                                <div style="margin: 0px;width: 360px;padding-bottom: 20px;padding-top: 40px;"><input class="form-control form-control-lg" type="text" name="product_name" placeholder="Name Of Product" required=""></div>
                                <div style="padding-bottom: 20px;width: 360px;margin: 0px;padding-top: 10px;"><textarea class="form-control form-control-lg" name="product_description" placeholder="Brief Description of Product" required="" maxlength="20"></textarea></div>
                                <div style="margin: 0px;padding-bottom: 20px;width: 360px;padding-top: 10px;"><input class="form-control form-control-lg" type="text" name="product_price" placeholder="R00.00" required="" maxlength="20" inputmode="numeric"></div>
                                ...
                                <div style="margin: 0px;padding-bottom: 0px;width: 360px;padding-top: 10px;"><input class="form-control form-control-lg" type="file" accept="image/*" required=""></div>
