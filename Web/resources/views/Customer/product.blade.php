        ...
        <div>
            <div class="row text-center justify-content-center align-items-center align-content-center">
                ...
                <div class="col text-center align-self-center">
                    <div class="shadow">
                        <h1 class="display-1">Black-Belt</h1>
                        <h1 class="display-6 fw-lighter text-muted">For Gaming Skills</h1>
                    ...
                    <form class="justify-content-center align-items-center align-content-center">
                        <div class="shadow d-grid justify-content-center align-items-center align-content-center mb-3">
                            <h1 class="display-5 text-center text-primary" style="height: 10px;">R 20.00</h1>
                            ...
                            <div class="col">
                                <p class="text-muted"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-patch-exclamation" style="height: 19.5938px;margin-right: 5px;margin-top: -5px;">
                                    ...
                                    </svg>Want to chat to the Vendor?&nbsp;<a href="#">Click Here</a></p>
                            </div>
                        </div>
                    </form>
                </div><a class="fs-6 text-center link-primary" href="{{route('Market')}}" style="width: 1054px;margin-top: 30px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-arrow-left-circle" style="margin-top: -2px;">
