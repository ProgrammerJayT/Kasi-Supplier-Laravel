        ...
        <div id="nav-bar" class="l-navbar">
            <nav class="nav">
                <div><a id="header_toggle-2" class="nav_logo header_toggle" href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor" class="fs-1 bx bx-layer nav_logo-icon" style="font-size: 12px;margin: -11px;height: 50px;">
                        ...
                        </svg><span class="nav_name">Folders</span></a><a class="nav_link active" href="{{route('Cart') }}"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="right" class="bx bx-bar-chart-alt nav_icon" title="Cart">
                    ...
                    <table class="table my-0" id="dataTable">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><a class="btn btn-outline-info btn-sm border rounded-pill border-info shadow-sm" role="button" style="padding-left: 20px;padding-right: 20px;" href="{{route('Payment')}}">Checkout</a></td>                            </tr>
                        </tfoot>
                    </table>
                </div>
                <div class="row">
