        ...
        <div id="sidemenu">
            <div id="nav-bar" class="l-navbar">
                <nav class="nav">
                    <div>
                        <div class="nav_list">
                            <a class="nav_link active" href="dashboard.html" title="Dashboard"><i
                                    ...
                                    Menu</span></a><a class="nav_link" href="markets.html"
                                ...
                                </svg><span class="nav_name">Folders</span></a><a class="nav_link" href="Wishlist.html"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                ...
                                </svg><span class="nav_name">Folders</span></a><a class="nav_link" href="cart.html"><svg
                ...
                <form>
                    <div class="align-items-center align-content-center">
                        <div class="input-group input-group-lg shadow"><span class="input-group-text"><svg
                            ...
                            </select><button class="btn btn-outline-warning border rounded-0 border-warning"
