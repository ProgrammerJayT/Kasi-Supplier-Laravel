                ...
                <div class="col-md-6 col-xl-3 mb-4">
                    <div class="card shadow-lg border-start-success py-2" data-bss-hover-animate="pulse">
                        <div class="card-body">
                            <div class="row align-items-center no-gutters">
                                <div class="col me-2">
                                    <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Successful
                                            Orders</span></div>
                                    <div class="text-dark fw-bold h5 mb-0"><span>23</span></div>
                                </div>
                                <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -64 640 640"
                                        width="1em" height="1em" fill="currentColor"
                                        class="text-success fa-2x text-gray-300">
                                        <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                        <path
                            ...
                            <div class="row align-items-center no-gutters">
                                <div class="col me-2">
                                    <div class="text-uppercase text-info fw-bold text-xs mb-1"><span
                                            class="text-danger">Cancelled orders</span></div>
                            ...
                            <div class="row align-items-center no-gutters">
                                <div class="col me-2">
                                    <div class="text-uppercase text-warning fw-bold text-xs mb-1"><span
                                            class="text-secondary" style="font-family: 'Nunito Sans', sans-serif;">Pending
                                            Orders</span></div>
                                    <div class="text-dark fw-bold h5 mb-0"><span>1</span></div>
                                </div>
                                <div class="col-auto"><i class="fas fa-comments text-secondary fa-2x text-gray-300"></i>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div style="text-align: right;">
            <a class="btn btn-outline-info btn-lg border rounded-pill border-info shadow" role="button"
                href="view-market" style="padding-right: 30px;padding-left: 30px;">Proceed To
                Market
            </a>
        </div>
    </div>
