...
<body>
    <div id="sidemenu" style="height: 20px;">
            ...
            <nav class="nav">
                <div><a id="header_toggle-2" class="nav_logo header_toggle" href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor" class="fs-1 bx bx-layer nav_logo-icon" style="font-size: 12px;margin: -11px;height: 50px;">
                            ...
                            <path d="M388.32,104.1a4.66,4.66,0,0,0-4.4-4c-2,0-37.23-.8-37.23-.8s-21.61-20.82-29.62-28.83V503.2L442.76,472S388.72,106.5,388.32,104.1ZM288.65,70.47a116.67,116.67,0,0,0-7.21-17.61C271,32.85,255.42,22,237,22a15,15,0,0,0-4,.4c-.4-.8-1.2-1.2-1.6-2C223.4,11.63,213,7.63,200.58,8c-24,.8-48,18-67.25,48.83-13.61,21.62-24,48.84-26.82,70.06-27.62,8.4-46.83,14.41-47.23,14.81-14,4.4-14.41,4.8-16,18-1.2,10-38,291.82-38,291.82L307.86,504V65.67a41.66,41.66,0,0,0-4.4.4S297.86,67.67,288.65,70.47ZM233.41,87.69c-16,4.8-33.63,10.4-50.84,15.61,4.8-18.82,14.41-37.63,25.62-50,4.4-4.4,10.41-9.61,17.21-12.81C232.21,54.86,233.81,74.48,233.41,87.69ZM200.58,24.44A27.49,27.49,0,0,1,215,28c-6.4,3.2-12.81,8.41-18.81,14.41-15.21,16.42-26.82,42-31.62,66.45-14.42,4.41-28.83,8.81-42,12.81C131.33,83.28,163.75,25.24,200.58,24.44ZM154.15,244.61c1.6,25.61,69.25,31.22,73.25,91.66,2.8,47.64-25.22,80.06-65.65,82.47-48.83,3.2-75.65-25.62-75.65-25.62l10.4-44s26.82,20.42,48.44,18.82c14-.8,19.22-12.41,18.81-20.42-2-33.62-57.24-31.62-60.84-86.86-3.2-46.44,27.22-93.27,94.47-97.68,26-1.6,39.23,4.81,39.23,4.81L221.4,225.39s-17.21-8-37.63-6.4C154.15,221,153.75,239.8,154.15,244.61ZM249.42,82.88c0-12-1.6-29.22-7.21-43.63,18.42,3.6,27.22,24,31.23,36.43Q262.63,78.68,249.42,82.88Z"></path>
                                ...
                                <div class="nav_list"><a class="nav_link" href="{{route('AdminDashboard')}}" title="Dashboard"><i class="fa fa-star bx bx-grid-alt nav_icon" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="right" title="Dashboard"></i><span class="nav_name">Main Menu</span></a><a class="nav_link" href="{{route('AdminMarket')}}" style="border-style: none;border-bottom-style: none;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-shop bx bx-folder nav_icon" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="right" title="Markets">
                            ...
                            </svg><span class="nav_name">Folders</span></a><a class="nav_link active" href="{{route('AdminApproval')}}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -64 640 640" width="1em" height="1em" fill="currentColor" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="right" class="bx bx-folder nav_icon" title="Approve Account">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                            ...
                            </svg><span class="nav_name">Folders</span></a></div><a class="nav_link signout" title="Signout"><i class="fa fa-star bx bx-log-out nav_icon" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="right" title="Signout"></i><span class="nav_name">Signout</span></a>
                </div>
            </nav>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 50px;width: 1500px;">
        <div class="card shadow-lg" style="height: 650px;">
            <div class="card-header justify-content-center align-items-center align-content-center py-3"><span class="fs-5 fw-lighter text-start text-primary">Account Infomation</span></div>
            <div class="card-body" style="background: #ffffff;">
                    ...
                    <table class="table my-0" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 250px;height: 39px;margin-top: 0px;padding-top: 21px;">First Name</th>
                        ...
                        <tbody>
                            <tr class="table-light justify-content-center" style="height: 1px;">
                                ...
                                <td style="padding-top: 10px;padding-right: 10px;padding-left: 0px;"><button class="btn btn-outline-success btn-sm border rounded-pill border-success" type="button" style="padding-bottom: 4px;margin-bottom: 10px;padding-top: 4px;padding-right: 20px;padding-left: 20px;">Approve</button><button class="btn btn-outline-danger btn-sm border rounded-pill border-danger" type="button" style="margin-right: 10px;padding-right: 20px;padding-left: 20px;">Remove&nbsp;</button></td>
                            </tr>
                            <tr class="table-light justify-content-center" style="height: 1px;">
                ...
                <div class="row">
                    <div class="col-md-6 align-self-center">
                        <p id="dataTable_info" class="dataTables_info" role="status" aria-live="polite">Showing 1 to 5 of $total_Sum</p>
                    </div>
                    <div class="col-md-6">
