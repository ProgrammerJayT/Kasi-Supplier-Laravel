            ...
            <nav class="nav">
                <div>
                    <div class="nav_list"><a class="nav_link active" href="dashboard.html" title="Dashboard"><i class="fa fa-star bx bx-grid-alt nav_icon" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="right" title="Dashboard"></i><span class="nav_name">Main Menu</span></a><a class="nav_link" href="markets.html" style="border-style: none;border-bottom-style: none;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-shop bx bx-folder nav_icon" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="right" title="Markets">
                            ...
                            </svg><span class="nav_name">Stats</span></a><a class="nav_link" href="google.com"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bank2 bx bx-bar-chart-alt nav_icon" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="right" title="Banking Details">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card shadow mb-5" style="margin: 0px -100px 48px;background: var(--bs-gray-dark);">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <div class="mb-3" style="margin: 0px 0px 50px;"><a class="btn btn-outline-secondary fs-5 border rounded-pill border-secondary shadow-sm d-block w-100" role="button" href="markets.html" style="margin: 60px 0px 16px;margin-bottom: 0px;margin-top: 10px;padding-right: 140px;padding-left: 140px;">Cancel</a></div>
                        </div>
                    </div>
                </div>
            </div>
