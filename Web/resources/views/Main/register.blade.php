                    ...
                    <div class="card shadow mb-5" style="margin: 0px -100px 48px;background: var(--bs-gray-dark);">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <form method="POST" class="text-center">
                                ...
                                <div style="margin: 30px 0px 16px;"><input class="form-control form-control-lg"
                                ...
                                <div style="margin: 0px 0px 16px;"><input class="form-control form-control-lg"
                                ...
                                <div style="margin: 0px 0px 16px;">
                                    <div class="input-group" style="margin: 0px 0px 16px;"><span
                                            class="input-group-text"><i class="far fa-user"></i></span><input
                                            class="form-control form-control-lg" type="text" name="username"
                                            placeholder="Username" value="{{ old('username') }}"></div>
                                ...
                                <div class="mb-3">
                                    <div class="input-group" style="margin: 0px 0px 16px;"><span
                                            ...
                                            </svg></span><input class="form-control form-control-lg" name="address"
                                            type="text" placeholder="Home Address" value="{{ old('address') }}">
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="input-group" style="margin: 0 0px 15px;margin-bottom: 15px;">
                                        <span class="input-group-text"><i class="fas fa-lock"></i></span>
                                        <input class="form-control form-control-lg" type="password" name="password"
                                            placeholder="Password">
                                        <span class="input-group-text" style="background: rgb(255,255,255);"><i
                                ...
                                <div class="mb-3" style="margin: 0px 0px 50px;"><button
                                        ...
                                        type="submit" style="margin: 60px 0px 16px;">Register Account</button></div>
